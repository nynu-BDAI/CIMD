...
class ThingsEEGDataset(Dataset):
    ...
    def _get_aligned_file_paths(self, project_dir, partition):
        ...
        text_global_root = os.path.join(project_dir, 'Description', 'deepseek_vl_global', img_part)
        text_color_root  = os.path.join(project_dir, 'Description', 'deepseek_vl_color',  img_part)
        text_emotion_root= os.path.join(project_dir, 'Description', 'deepseek_vl_emotion',img_part)
